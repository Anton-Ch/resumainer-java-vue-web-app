<template>
  <div>
    <ProfileSectionHeader :title="$t('profile.contact.title')" :purpose="$t('profile.contact.purpose')" />
    <div class="stub-placeholder">
      <i class="pi pi-spin pi-spinner" style="font-size: 1.5rem; color: var(--vue-text-muted);"></i>
