  ...
  >
    <template v-if="mode === 'view' && course">
      <div class="detail-grid">
        ...
        <div class="detail-field-full" v-if="course.courseFocus">
          <div class="detail-label">{{ $t('profile.courses.skills') }}</div>
          <div class="detail-value">{{ course.courseFocus }}</div>
        </div>
    ...
    <template v-else-if="mode !== 'view'">
      <div class="edit-form">
        ...
        <div class="form-group">
          ...
          <InputText v-model="editForm.courseFocus" class="form-input" />
        </div>
        <div class="form-group">
...
watch(() => props.course, (course) => {
  if (course && props.mode === 'edit') {
    ...
    editForm.courseFocus = course.courseFocus
...
function switchToEdit() {
  if (props.course) {
    ...
    editForm.courseFocus = props.course.courseFocus
...
function onSave() {
  ...
  const course: Course = {
    ...
    courseFocus: editForm.courseFocus,
