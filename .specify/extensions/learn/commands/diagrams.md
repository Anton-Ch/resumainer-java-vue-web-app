---
description: Generate visual diagram files (component, system design, software architecture) with Mermaid illustrations and reasoning derived from core spec artifacts — designed to help engineers internalize architecture before implementation.
scripts:
